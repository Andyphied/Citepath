...
from app.infrastructure.llm.openai_completion import OpenAIChatCompletionProvider
...
def create_completion_provider(settings: Settings) -> ChatCompletionProvider:
    """Build the configured chat completion provider from application settings."""
    return OpenAIChatCompletionProvider(settings=settings)
